...
public class MapLocationActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        mGoogleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                startActivity(new Intent(MapLocationActivity.this, ServiceDetailActivity.class));
                return true;
            }
        });
    }
    ...
    public void onLocationChanged(Location location)
    {
        ...
        //move map camera
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, mZoomLvl));

        dummyMarkers(new LatLng(location.getLatitude(), location.getLongitude()));
        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, this);
    }
